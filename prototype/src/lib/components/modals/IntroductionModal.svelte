    ...
    <div class="mt-4 w-full h-auto grid grid-cols-1 gap-4">
        ...
        <table class="w-fit">
            <thead>
                <tr>
                    <td class="px-2">Nr.</td>
                    <td class="px-2">Ort</td>
                    <td class="px-2">Rätsel</td>
                    <td class="px-2">Punkte</td>
                </tr>
            </thead>
            <tbody>
                <tr>
            ...
            <tfoot>
                <tr>
                    <td colspan="4" class="text-left">Gesamt: 207 Punkte</td>
                </tr>
            </tfoot>
        </table>
        <hr />
