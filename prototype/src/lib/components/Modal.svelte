<script lang="ts">
    let { children, show = $bindable(), confirmButtonText, closeButtonText, onConfirm = () => {}} : { children: Function, show: Function, confirmButtonText?: string, closeButtonText?: string, onConfirm?: () => void }= $props()
