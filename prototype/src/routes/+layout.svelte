...
<div class="w-screen h-auto min-h-dvh bg-primary">
    <div class="w-full h-auto border-b-2 border-secondary">
        <div class="mx-auto w-full max-w-xl">
            <div class="w-full h-14 text-secondary flex justify-between items-center px-4">
    ...
    <PageTransition>
        <div class="mx-auto w-full max-w-xl h-auto p-4">
            {@render children()}
        </div>
        <div class="mx-auto w-full max-w-xl h-auto border-t border-secondary p-4 pt-2">
