...
<div class="relative w-full h-auto">
    ...
    <h3 class="text-lg underline place-self-center">Rätsel 000</h3>
</div>
...
<p class="my-4 w-full h-auto text-sm">
    Statte ihn mit den richtigen Gegenständen aus. Aber Achtung: Nur <strong>fünf Gegenstände</strong> sind
    <strong>richtig!</strong> Tipp: Schau doch mal in die Reinoldi Kirche, ob Du Reinoldus entdecken kannst.
    <strong>Wichtig:</strong> Bitte mache ein <strong>Foto</strong> von Reinoldus und löse das Rätsel <strong>außerhalb der Kirche</strong>,
