...
<p class="my-4 w-full h-auto text-sm">
    Ordne den Zünften das richtige Handwerk zu. Aber Achtung: es gibt nur <strong>sieben richtige
    Paare!</strong> Es wurden <strong>drei Zünfte dazu gemischt.</strong> Schaffst Du es, die <strong>richtigen Paare</strong> zu
    finden?
</p>

<p class="my-4 w-full h-auto text-sm">
    <strong>Zünfte:</strong> Schmied, Fleischer, Bäcker, Bader, Tuchmacher, Gerber, Schuhmacher, Krämer,
    Fettkrämer, Abdecker
</p>

<p class="my-4 w-full h-auto text-sm">
    <strong>Handwerk:</strong> Metallverarbeitung, Getreideverarbeitung, Fleischverarbeitung,
