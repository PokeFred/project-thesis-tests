...
{#if station.state === "DONE"}
    <button onclick={(): Promise<void> => goto(`./stations/${station.identifier}`)} class="w-full h-auto bg-green-500/15 border-2 border-green-500 rounded-xl grid grid-cols-[24px_auto_48px] gap-4 cursor-pointer p-4">
